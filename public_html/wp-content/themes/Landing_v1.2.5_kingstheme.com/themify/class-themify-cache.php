...
class TFCache {
    ...
    public static function is_cache_activate() {
        $active = (is_user_logged_in() && current_user_can('manage_options'))  || is_admin() || themify_get('setting-page_builder_cache') !== 'enable'  || themify_get('setting-page_builder_is_active') != 'enable' ? true : false;
