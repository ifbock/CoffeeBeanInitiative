...
<div class="themify-portfolio-posts">
	...
	<div class="loops-wrapper shortcode <?php echo $post_type; ?> <?php echo $style ?> <?php echo ( $query->post_count > 1 ) ? 'portfolio-multiple clearfix type-multiple' : 'portfolio-single' ?> ">
